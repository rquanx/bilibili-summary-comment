...
import { buildSummarySegmentsFromSrt, formatSummaryTime, parseSrt } from "./lib/srt-utils.mjs";
import { getRepoRoot, loadDotEnvIfPresent } from "./lib/runtime-tools.mjs";
import { normalizeSummaryOutput, requestSummary, resolveSummaryConfig } from "./lib/summarizer.mjs";
...
function buildPromptSnapshot({ sampleName, pageNo, partTitle, candidate, subtitleText, segments }) {
  const lines = [
    `sample: ${sampleName}`,
    "promptSource: scripts/lib/summarizer.mjs#requestSummary",
