...
import { firstNonEmptyString } from "./subtitle-utils.mjs";
...
export function buildLocalFasterWhisperModelPathCandidates(env = process.env) {
...
export function inferFasterWhisperModelName(value) {
...
export function buildLocalFasterWhisperExecutableDirCandidates(env = process.env) {
  return uniqueNonEmptyPaths([
...
export function findFasterWhisperProgramInDir(directory, existsSync = fs.existsSync) {
